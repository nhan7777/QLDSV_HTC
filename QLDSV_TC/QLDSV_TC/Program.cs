...
namespace QLDSV_TC
{
    static class Program
    {
        ...
        public static String connstr_publicsher = "Data Source=HOAIDANG\\HOME;Initial Catalog=QLDSV_TC;Persist Security Info=True;User ID=sa;Password=123";
        ...
        public static RibbonMenu mainForm;
